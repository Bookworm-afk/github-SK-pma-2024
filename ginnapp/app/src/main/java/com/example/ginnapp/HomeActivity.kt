...
class HomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) { //Sets up the home screen with navigation options to other activities
    ...
    private fun showToast(message: String) { //Displays a toast message with the provided text
        Toast.makeText(this, message, Toast.LENGTH_SHORT).show()
    }
}
@Composable
fun HomeScreen(onButtonClick: (String) -> Unit) { //Provides buttons for navigating to Dog Walking Activity, Statistics Activity, or exiting the app
